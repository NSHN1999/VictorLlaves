...
export const HomePage = () => {
    ...
    return (
        <section className="h-[600px] w-full bg-[#EAE21E] rounded-xl p-[10px] pb-[20px]">
            ...
            <div className="p-[10px] pb-[40px] mt-[40px] bg-white rounded-md shadow-[0px_px_5px_5px] shadow-[rgba(0,0,0,0.4)]">
                <h2 className="1xl text-center h-auto py-[15px] text-neutral-700 font-medium">
                    ¿Tienes un problema con tu llave?
                </h2>
                <p className="text-center p-[10px] font-poppins text-neutral-700">
                    Envíame una solicitud y buscare la solución a tu problema.
                </p>
